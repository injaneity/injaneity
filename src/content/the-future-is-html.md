...
But recently, I've shifted my approach to web development and design. Frontend in the agent era has always been aesthetics first, performance later - but an article I read recently shifted the tune for me. It's about being [**HTML-first**](https://mohkohn.co.uk/writing/html-first/), making sure that websites run on even the worst of devices, not just the latest iPhone.

There's two main inspirations for the switch to HTML-first:

### The aesthetics of e-ink (and not burning your eyes)
![Photo of e-ink display](/images/e-ink.jpg)
